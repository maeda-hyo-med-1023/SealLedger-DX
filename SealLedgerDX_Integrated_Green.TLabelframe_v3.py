...
class SealLedgerDXApp:
    ...
    def setup_tab1(self, bg_color, label_style):
        ...
        ttk.Label(row5, text="設定列（複数可：A,B）：").pack(side="left", padx=10)
        self.val_target_col = tk.StringVar(value="E")
        ttk.Entry(row5, textvariable=self.val_target_col, width=8, font=self.base_font).pack(side="left")
