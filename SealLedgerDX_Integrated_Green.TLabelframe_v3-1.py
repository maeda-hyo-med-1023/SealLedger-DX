...
class SealLedgerDXApp:
    ...
    def setup_tab1(self, bg_color, label_style):
        ...
        ttk.Button(row5, text="▶ 入力規則セット", command=self.run_validation_set, style="Green.TButton").pack(side="left", padx=10) ttk.Button(row5, text="▶ 入力規則セット", command=self.run_validation_set, style="Green.TButton").pack(side="left", padx=10)
