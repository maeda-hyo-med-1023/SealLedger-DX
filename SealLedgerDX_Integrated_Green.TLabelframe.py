...
class SealLedgerDXApp:
    def __init__(self, root):
        ...
        self.style.configure("Green.TLabelframe.Label", foreground="#1B5E20", font=("Meiryo", 10, "bold"))
        ...
        for i, color in enumerate(tab_colors):
            ...
            self.style.configure(f"{style_name}.Label", foreground="#1B5E20", font=("Meiryo", 10, "bold"))
    ...
    def setup_tab1(self, bg_color, label_style):
        ...
        frame1 = ttk.LabelFrame(parent, text="①-1 Excelフォーマット複製（ページ追加）", style=label_style, padding=pad)
    ...
    def setup_t4_sub1(self, bg_color):
        parent = self.sub1
        parent.configure(bg=bg_color)  # ← tk.Frame なので bg が使える
        pad = 10
